...
urlpatterns = [
    ...
    path("latest-solutions/", views.solutions_showcase, name="solutions_showcase"),
    ...
    path("sample/<str:sha256>/<int:task_id>/solution/onsite/", views.onsite_solution_editor, name="onsite_solution_editor"),
    ...
    path("sample/<str:sha256>/<int:task_id>/attach-draft/", views.attach_draft_to_sample, name="attach_draft_to_sample"),
    path("upload-editor-image/", views.upload_editor_image, name="upload_editor_image"),    # Articles (draft articles)
    path("articles/", views.article_list, name="article_list"),
    path("articles/new/", views.article_editor, name="article_editor"),
    path("articles/<int:article_id>/", views.article_view, name="article_view"),
    path("articles/<int:article_id>/edit/", views.article_editor, name="article_editor_edit"),
    path("articles/<int:article_id>/delete/", views.article_delete, name="article_delete"),
    path("articles/<int:article_id>/unpublish/", views.article_unpublish, name="article_unpublish"),
    path("articles/<int:article_id>/publish/", views.publish_article, name="publish_article"),
    # AJAX endpoints
